...
#PACKAGES="$PACKAGES kmod-usb-net kmod-usb-net-cdc-ether kmod-usb-net-rndis usbutils kmod-usb2 kmod-usb3 comgt"
PACKAGES="$PACKAGES luci-i18n-ddns-zh-cn"
PACKAGES="$PACKAGES luci-i18n-upnp-zh-cn"
#PACKAGES="$PACKAGES luci-i18n-cifs-mount-zh-cn"
#PACKAGES="$PACKAGES luci-i18n-p910nd-zh-cn kmod-lp kmod-usb-printer"
